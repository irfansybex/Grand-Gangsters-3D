...
public static class NGUITools
{
	...
	{
		SetActiveRecursivelySelf(t.gameObject, true);
		int i = 0;
	...
	{
		SetActiveRecursivelySelf(t.gameObject, false);
	}
	...
	public static void SetActiveRecursivelyChildren(GameObject go, bool state)
	{
		Transform transform = go.transform;
		if (state)
		{
	...
	public static void SetActiveRecursivelySelf(GameObject go, bool state)
	{
